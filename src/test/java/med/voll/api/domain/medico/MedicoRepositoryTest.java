...
class MedicoRepositoryTest {
    ...
    void escolherMedicoAleatorioLivreNaDataCenario1() {
        ...
        var proximaSegundaAs10 = LocalDate.now()
                ...
                .atTime(10, 0);
        var medico = cadastrarMedico("Médico Teste", "medico@voll.med", "123456", Especialidade.CARDIOLOGIA);
        var paciente = cadastrarPaciente("Paciente Teste", "paciente@teste.com", "12345678901");
    ...
    void escolherMedicoAleatorioLivreNaDataCenario2() {
        ...
        var proximaSegundaAs10 = LocalDate.now()
                .with(TemporalAdjusters.next(DayOfWeek.MONDAY))
                .atTime(10, 0);
        var medico = cadastrarMedico("Medico Teste", "medico@voll.med", "123456", Especialidade.CARDIOLOGIA);
